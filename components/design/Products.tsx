...
export const Products: React.FC<Props> = ({ edit, order, setOrder, productsOrder, setPages, design, categories, pages, index, ind, inde, indx, inx, inxx, funnels, setFunnels, services, setServices, style }) => {
  ...
  return (
    <div className='px-4 py-10' style={{ background: `${design.info.typeBackground === 'Degradado' ? design.info.background : design.info.typeBackground === 'Color' ? design.info.background : ''}`, color: design.info.textColor }}>
            ...
            : (
              <div className="w-full max-w-[1600px] m-auto flex flex-col gap-4 flex-wrap justify-around">
                ...
                <div className='flex gap-2 m-auto'>
                  ...
                  }} className='p-1.5 rounded border bg-transparent'>
